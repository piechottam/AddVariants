...
public class BEDlikeVariantWriter<T extends BaseQualRecordData> 
extends AbstractVariantFileWriter<T> {

	public final static char COMMENT = '\t';
	public final static char SEP = '\t'; 
	
	public BEDlikeVariantWriter(final String filename, final BEDlikeVariantFormat<T> format) {
		super(filename, format);
	}

	@Override
	public void addHeader(final List<Condition<T>> conditions) {
